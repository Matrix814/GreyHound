...
def main():
    ...
    index = sys.argv[2]
    days = 0
    columns = GREY_FUNCTIONS.txt2list("./Columns/columns.txt")
    ...
    LFA_percentage = .05
    GREY_FUNCTIONS.redux_search_multiple(es_node, index, days, query_list, ip_whitelist, columns,path2result,postfix)
    final_unsorted_dict = {}
    for day in days:
